...
export function HeroSection({}: HeroSectionProps) {
  return (
    <section className="w-full min-h-[auto] md:min-h-[90vh] bg-gradient-to-b from-white via-white to-gray-50/30 relative overflow-hidden flex items-center py-6 md:py-0">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col md:flex-row items-center gap-0 md:gap-8 lg:gap-12">
          {/* Left content - Text & CTAs - Mobile First - Balanced Spacing */}
          <div className="flex-1 w-full md:w-auto py-2 md:py-12 relative z-10 flex flex-col justify-center">
            {/* Badge/Trust Indicator - Mobile optimized - Balanced */}
            <div className="inline-flex items-center gap-1 mb-2 md:mb-3 px-2 py-0.5 bg-gray-100 rounded-full w-fit text-[10px] md:text-xs">
            ...
            <Heading 
              level={1} 
              className="text-xl sm:text-2xl md:text-6xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-2 md:mb-4 leading-[1.1] tracking-tight"
            >
              Your Gateway to the{' '}
            ...
            <Text className="text-[10px] md:text-lg lg:text-xl text-gray-700 max-w-2xl mb-2 md:mb-3 leading-tight md:leading-relaxed">
            ...
            <Text className="text-[9px] md:text-base text-gray-600 max-w-2xl mb-2.5 md:mb-6 leading-tight md:leading-relaxed">
            ...
            <div className="flex flex-wrap gap-1.5 mb-2.5 md:mb-6 md:flex-row md:gap-3">
            ...
            <div className="flex-1 w-full relative min-h-[100px] flex items-center justify-center mb-2.5 md:hidden">
