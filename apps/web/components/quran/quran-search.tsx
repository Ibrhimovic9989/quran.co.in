      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            'focus:outline-none focus:ring-2 focus:ring-ink/50 focus:border-transparent',
        ...
        {searchQuery && (
          <button
            ...
            className="absolute right-2.5 md:right-3 top-1/2 -translate-y-1/2 p-1 hover:bg-line-soft rounded-full transition-colors duration-300"
            aria-label="Clear search"
          >
            <X className="w-3.5 h-3.5 md:w-4 md:h-4 text-muted" />
          </button>
        )}
      </div>
    </div>
