      ...
      <div className="py-6 md:py-20">
        ...
        {!hasMore && filteredSurahs.length === 0 && searchQuery && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <div className="w-16 h-16 bg-line-soft rounded-full flex items-center justify-center mb-4">
              <svg className="w-8 h-8 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <Heading level={3} className="text-lg font-bold text-ink mb-2">
              No results for &ldquo;{searchQuery}&rdquo;
            </Heading>
            <Text className="text-muted text-sm max-w-xs">
