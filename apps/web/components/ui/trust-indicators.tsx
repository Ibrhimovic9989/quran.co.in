            ...
            >
              ...
              <div className="mb-2 md:mb-3 flex justify-center">
                <div className={cn(
                  ...
                  point.iconBg,
                  "text-ink shadow-sm group-hover/data:scale-110 transition-transform duration-300"
                )}>
                  {point.icon}
                </div>
              </div>
              ...
              <div className={cn(
                "font-bold text-ink mb-1 md:mb-2",
              ...
              <div className="text-[10px] md:text-sm text-ink-soft font-medium leading-tight">
                {point.label}
              </div>
            </Card>
          ))}
              ...
              <div className="space-y-2.5 md:space-y-4">
                {qualityIndicators.map((indicator, index) => (
                  <div key={index} className="flex items-start gap-2 md:gap-3">
                    <div className="flex-shrink-0 mt-0.5 text-ink-soft">
                      {indicator.icon}
                    </div>
                    <Text className="text-xs md:text-base text-ink-soft leading-relaxed">
                      {indicator.text}
                    </Text>
                  </div>
                ))}
