    ...
    <main className="min-h-screen bg-surface pt-24 pb-16">
      <Container>
        ...
        <div className="max-w-3xl mb-16">
          <Heading level={1} className="text-4xl md:text-6xl font-bold text-ink mb-6">
            Our Mission: To Make the Quran Accessible to All
          </Heading>
          <Text className="text-lg md:text-xl text-ink-soft leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          <Card className="p-8 border border-line-soft shadow-sm hover:shadow-md transition-shadow">
        ...
        {/* Story Section */}
        <div className="bg-surface-warm rounded-3xl p-8 md:p-16">
          <div className="max-w-3xl mx-auto text-center">
            <Heading level={2} className="text-3xl md:text-4xl font-bold mb-8">Guided by Faith</Heading>
            <Text className="text-lg text-ink-soft leading-relaxed mb-8 italic">
