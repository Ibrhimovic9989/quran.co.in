...
//
// The API-surah → DB-upsert mapping and the DB-surah → response mapping were
// previously copy-pasted across quran.service, quran-cache.service and
// quran-surah-list-cache. Any field change had to be made in 4 places. These
// helpers centralise that mapping so there is exactly one definition.

import type { ApiProvider } from '@prisma/client';
import type { SurahInfo, SurahResponse } from '@/types/quran-api';
import type { UpsertSurahInput } from '@/lib/repositories/quran.repository';
